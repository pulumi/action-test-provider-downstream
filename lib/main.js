    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!openPullRequest) {
                ...
                for (const replace of replacements) {
                    yield exec_1.exec("go", ["mod", "edit", `-require=${replace.module}@${checkoutSHA}`], inDownstreamModOptions);
                }
            }
            // Prepare the go.mod file
            yield exec_1.exec("go", ["mod", "download"], inDownstreamModOptions);
            if (openPullRequest) {
                yield exec_1.exec("go", ["mod", "tidy"], inDownstreamModOptions);
            }
            ...
            const buildChanges = yield exec_1.exec("git", ["diff", "--stat"], inDownstreamOptions);
            ...
            if (hasPulumiBotToken && hasGitHubActionsToken) {
                ...
                yield exec_1.exec("git", ["push", "origin", branchName], inDownstreamOptions);
                if (openPullRequest) {
